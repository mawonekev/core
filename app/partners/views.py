...
@extend_schema(
    ...
    description=(
        ...
        '**POST** — Submit a partner application. **Requires staff/admin privileges** (prevents fake partnerships).\n\n'
        '**curl GET example:**\n'
        '```bash\n'
        'curl "https://xenohuru.cleven.is-a.dev/api/v1/partners/"\n'
        '```'
    ),
    parameters=[
    ...
    responses={
        ...
        403: OpenApiResponse(description='Only admin/staff can create partners (anti-scam protection).'),
    },
)
@api_view(['GET', 'POST'])
...
@extend_schema(
    ...
    description=(
        ...
        '- **PUT/PATCH** — Update. **Admin/staff only** (prevents unauthorized changes).\n'
        '- **DELETE** — Remove partner. **Admin/staff only**.\n\n'
        '**curl GET example:**\n'
        '```bash\n'
        'curl https://xenohuru.cleven.is-a.dev/api/v1/partners/acacia-foundation/\n'
        '```'
    ),
    responses={
        ...
        403: OpenApiResponse(description='Only admin/staff can modify partners.'),
