...
def make_partner(name='Tanzania Tourism Board', slug='tanzania-tourism-board', tier='gold'):
    ...
    # note: Partner does not extend BaseModel so no is_approved field
...
class PartnersAPITest(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(username='partneruser', email='partner@example.com', password='Pass1234!', is_staff=True)
